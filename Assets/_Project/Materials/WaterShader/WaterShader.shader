...
Shader "WaterShader"
{
	Properties
	{
		...
		_ColorA("ColorA", Color) = (0.4292453,0.711248,1,0)
		[HDR]_ColorB("ColorB", Color) = (1.964049,2.288388,2.297397,0)
		_Opacity("Opacity", Range( 0 , 1)) = 1
		_Smoothness("Smoothness", Range( 0 , 1)) = 0
		[HDR]_IntersectColor("Intersect Color", Color) = (0.03137255,0.2588235,0.3176471,1)
		_FoamIntencity("FoamIntencity", Float) = 0
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float2 _UVSpeed1;
			uniform float2 _UVSpeed2;
				...
				) : SV_Target
			{
				...
				float4 lerpResult26 = lerp( _ColorA , _ColorB , ( tex2D( _MainTex, (IN.ase_texcoord9.xy*_Scale + ( _UVSpeed1 * _Time.y )) ) * tex2D( _MainTex, (IN.ase_texcoord9.xy*( _Scale / 2.0 ) + ( _UVSpeed2 * _Time.y )) ) ));
				...
				float distanceDepth40 = abs( ( screenDepth40 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _FoamIntencity ) );
				float clampResult41 = clamp( distanceDepth40 , 0.0 , 1.0 );
				float4 lerpResult42 = lerp( _IntersectColor , lerpResult26 , clampResult41);
		...
		Pass
		{
			...
			)
			{
				...
				float4 lerpResult26 = lerp( _ColorA , _ColorB , ( tex2D( _MainTex, (IN.ase_texcoord8.xy*_Scale + ( _UVSpeed1 * _Time.y )) ) * tex2D( _MainTex, (IN.ase_texcoord8.xy*( _Scale / 2.0 ) + ( _UVSpeed2 * _Time.y )) ) ));
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 lerpResult26 = lerp( _ColorA , _ColorB , ( tex2D( _MainTex, (IN.ase_texcoord3.xy*_Scale + ( _UVSpeed1 * _Time.y )) ) * tex2D( _MainTex, (IN.ase_texcoord3.xy*( _Scale / 2.0 ) + ( _UVSpeed2 * _Time.y )) ) ));
...
Node;AmplifyShaderEditor.SamplerNode;6;-722,-98.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;8f48203fad64f9e4fb2c435eacb3ef35;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleAndOffsetNode;7;-990,-83.5;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;10;-1259,-145.5;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-727,346.5;Inherit;True;Property;_MainTex1;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;6;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;18;-1209,487.5;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;17;-1334.5,350.5;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleAndOffsetNode;16;-993.5,423.5;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-1155,124.5;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;15;-1374,231.5;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1134.333,683.5;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;21;-1353.333,790.5;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;13;-1370,68.5;Inherit;False;Property;_UVSpeed1;UV Speed 1;3;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;19;-1349.333,627.5;Inherit;False;Property;_UVSpeed2;UV Speed 2;1;0;Create;True;0;0;0;False;0;False;-0.1,0.1;-0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-382,144.5;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;26;-54,66.5;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-385,475.5;Inherit;False;Property;_Smoothness;Smoothness;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;27;-355,-250.5;Inherit;False;Property;_ColorA;ColorA;4;0;Create;True;0;0;0;False;0;False;0.4292453,0.711248,1,0;0.4292451,0.711248,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;28;-354,-63.5;Inherit;False;Property;_ColorB;ColorB;5;1;[HDR];Create;True;0;0;0;False;0;False;1.964049,2.288388,2.297397,0;1.490199,3.067205,3.067205,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1204,-18.5;Inherit;False;Property;_Scale;Scale;2;0;Create;True;0;0;0;False;0;False;4;300;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-381,570.5;Inherit;False;Property;_Opacity;Opacity;6;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-386,368.5;Inherit;False;Property;_Metalic;Metalic;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;749.2998,337.0409;Float;False;True;-1;2;ASEMaterialInspector;0;4;WaterShader;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;638478972774158280;Surface;1;638464313166225283;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;0;638478972813806596;Two Sided;1;0;Deferred Pass;1;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.DepthFade;40;-180.196,1112.955;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;41;110.0569,1089.683;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;42;224.5508,839.2932;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-396.6458,1113.881;Inherit;False;Property;_FoamIntencity;FoamIntencity;10;0;Create;True;0;0;0;False;0;False;0;0.43;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;44;-128.4393,788.2903;Float;False;Property;_IntersectColor;Intersect Color;9;1;[HDR];Create;True;0;0;0;False;0;False;0.03137255,0.2588235,0.3176471,1;0.4301988,0.4301988,0.4301988,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EA471FE656AE459E8C0F28EEA77FCAC6890CE5AC